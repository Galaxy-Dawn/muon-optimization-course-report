...
This repository contains the source files and reproducibility materials for a graduate course report on Muon-style matrix optimization.
...
- Matrix-sign RMS checks across matrix shapes.
...
Code is released under the MIT License. The report source, figures, and generated outputs are included for transparency and reproducibility.
