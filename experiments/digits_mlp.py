...
steps for Muon variants.  Cov-MuonW uses oracle full-batch covariances, so it is a diagnostic
implementation rather than a scalable finite-Newton--Schulz method.
"""
import os
...
def main():
    ...
    plot_methods = ["sgd", "adam", "adamw", "muon", "muonw", "rms_muonw", "cov_muonw"]
